...
public class MainActivity extends SherlockFragmentActivity implements
		ActionBar.TabListener { // NO_UCD (use default)
	...
	private TestDropdownAdapter mTestDropdownAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// ThreadPolicy.Builder().detectDiskReads().detectDiskWrites().penaltyLog().penaltyDeath().build());
		...
		mTestDropdownAdapter = new TestDropdownAdapter(this,
				R.layout.navigation_item_layout, new String[] { "option 1",
						"option 2" });

		actionBar.setListNavigationCallbacks(mTestDropdownAdapter, null);
		...
		// If our activity was opened by choosing a file from a mail attachment
		// or file manager, file browser, or other program, import the database
		// from this file.
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_import:
			...
			startActivityForResult(
					Intent.createChooser(importIntent,
							getResources().getText(R.string.action_import)),
					ACTIVITY_REQUEST_CODE_IMPORT);
			return true;
		case R.id.action_share:
			// Build a chooser dialog for the file format.
			ScrumChatterDialog.showChoiceDialog(this,
					R.string.export_choice_title, R.array.export_choices,
					new DialogInterface.OnClickListener() {

						@Override
						public void onClick(DialogInterface dialog, int which) {
							String[] exportChoices = getResources()
									.getStringArray(R.array.export_choices);
							FileExport fileExport = null;
							if (getString(R.string.export_format_excel).equals(
									exportChoices[which]))
								fileExport = new MeetingsExport(
										MainActivity.this);
							else if (getString(R.string.export_format_db)
	...
	protected void onActivityResult(int requestCode, int resultCode,
		...
		if (requestCode == ACTIVITY_REQUEST_CODE_IMPORT
			...
			if (intent.getData() == null) {
				Toast.makeText(this, R.string.import_result_no_file,
			...
			if (!file.exists()) {
				Toast.makeText(
						this,
						getString(R.string.import_result_file_does_not_exist,
	...
	private void importDB(final Uri uri) {
		ScrumChatterDialog
				.showDialog(
						...
						getString(R.string.import_confirm_message,
								uri.getEncodedPath()), new OnClickListener() {
								...
								if (which == DialogInterface.BUTTON_POSITIVE) {
									AsyncTask<Void, Void, Boolean> task = new AsyncTask<Void, Void, Boolean>() {
										...
										protected void onPostExecute(
											...
											Toast.makeText(
													MainActivity.this,
													result ? R.string.import_result_success
															: R.string.import_result_failed,
													Toast.LENGTH_SHORT).show();
										}
	 ...
	 * 
	 * @param fileExport
	 *            The object responsible for creating the file to share.
	 */
	private void shareFile(final FileExport fileExport) {
		...
		AsyncTask<Void, Void, Boolean> asyncTask = new AsyncTask<Void, Void, Boolean>() {
			...
			protected void onPostExecute(Boolean success) {
				...
				if (!success)
					Toast.makeText(MainActivity.this, R.string.export_error,
	...
	private class TestDropdownAdapter extends ArrayAdapter<CharSequence> {

		public TestDropdownAdapter(Context context, int textViewResourceId,
		 ...
		 * ViewGroup parent) { // TODO Auto-generated method stub return
