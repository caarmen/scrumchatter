...
public class ScrumChatterDatabase extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_TABLE_MEETING_MEMBER = "CREATE TABLE IF NOT EXISTS "
            ...
            + MeetingMemberColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
            + MeetingMemberColumns.MEETING_ID + " INTEGER, "
            + MeetingMemberColumns.TEAM_MEMBER_ID + " INTEGER, "
            + MeetingMemberColumns.DURATION + " INTEGER "
            + ", CONSTRAINT UNIQUE_MEETING_MEMBER UNIQUE ( MEETING_ID, TEAM_MEMBER_ID ) ON CONFLICT REPLACE"
    ...
    private static final String SQL_CREATE_TABLE_MEETING = "CREATE TABLE IF NOT EXISTS "
            ...
            + MeetingColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
            + MeetingColumns.MEETING_DATE + " INTEGER, "
            + MeetingColumns.DURATION + " INTEGER, "
            + MeetingColumns.AGE + " INTEGER "
            + " );";
